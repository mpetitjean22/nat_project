...
var udpCheckSumTest = [][]byte{
	[]byte{0x52, 0x54, 0x0, 0x12, 0x35, 0x2, 0x8, 0x0, 0x27, 0xfd, 0x6, 0x32, 0x8, 0x0, 0x45, 0x0, 0x0, 0x1d, 0x0, 0x0, 0x0, 0x0, 0x40, 0x11, 0x5e, 0xb2, 0xa, 0x0, 0x2, 0xf, 0x8, 0x8, 0x8, 0x8, 0xd6, 0xd9, 0x0, 0x50, 0x0, 0x9, 0x5, 0x94, 0x7, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0},
	[]byte{0x52, 0x54, 0x0, 0x12, 0x35, 0x2, 0x8, 0x0, 0x27, 0xfd, 0x6, 0x32, 0x8, 0x0, 0x45, 0x0, 0x0, 0x1d, 0x4, 0x42, 0x0, 0x0, 0x40, 0x11, 0x60, 0x79, 0x3, 0x3, 0x3, 0x3, 0x8, 0x8, 0x8, 0x8, 0xd6, 0xd9, 0x0, 0x50, 0x0, 0x9, 0xb, 0x9d, 0x7, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0},
	[]byte{0x52, 0x54, 0x0, 0x12, 0x35, 0x2, 0x8, 0x0, 0x27, 0xfd, 0x6, 0x32, 0x8, 0x0, 0x45, 0x0, 0x0, 0x3c, 0xbe, 0x56, 0x40, 0x0, 0x40, 0x6, 0x6e, 0x55, 0xa, 0x0, 0x2, 0xf, 0x1, 0x1, 0x1, 0x1, 0xe0, 0x56, 0x0, 0x50, 0xf2, 0xca, 0x29, 0x4c, 0x0, 0x0, 0x0, 0x0, 0xa0, 0x2, 0xfa, 0xf0, 0x28, 0x49, 0x0, 0x0, 0x2, 0x4, 0x5, 0xb4, 0x4, 0x2, 0x8, 0xa, 0x49, 0x92, 0xdd, 0xc2, 0x0, 0x0, 0x0, 0x0, 0x1, 0x3, 0x3, 0x7},
}

var tcpCheckSumTest = [][]byte{
	[]byte{0x52, 0x54, 0x0, 0x12, 0x35, 0x2, 0x8, 0x0, 0x27, 0xfd, 0x6, 0x32, 0x8, 0x0, 0x45, 0x0, 0x0, 0x29, 0x4, 0x42, 0x0, 0x0, 0x40, 0x6, 0x5c, 0x73, 0xa, 0x1, 0x0, 0xa, 0x8, 0x8, 0x8, 0x8, 0x0, 0x50, 0x0, 0x50, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x50, 0x0, 0x0, 0x0, 0x8e, 0x29, 0x0, 0x0, 0x7, 0x0, 0x0, 0x0, 0x0, 0x0},
	[]byte{0x8, 0x0, 0x27, 0xfd, 0x6, 0x32, 0x52, 0x54, 0x0, 0x12, 0x35, 0x2, 0x8, 0x0, 0x45, 0x0, 0x0, 0x28, 0xac, 0x8f, 0x0, 0x0, 0x40, 0x6, 0xb8, 0x34, 0xa, 0x0, 0x2, 0x2, 0xa, 0x1, 0x0, 0xa, 0xef, 0xa0, 0x0, 0x16, 0xf, 0xf4, 0xb5, 0xfb, 0xf9, 0x1b, 0xf5, 0x2d, 0x50, 0x10, 0xff, 0xff, 0xf5, 0xd7, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0},
}

func TestUDPCheckSum(t *testing.T) {
	for idx, packetData := range udpCheckSumTest {
		endIPHeader := ((uint8(packetData[14]) & 0x0F) * 4) + 14

		checksum := binary.BigEndian.Uint16(packetData[endIPHeader+6 : endIPHeader+8])
		checksum2 := binary.BigEndian.Uint16(packetData[14+10 : 14+12])

		updateCheckSum(packetData)

		got := binary.BigEndian.Uint16(packetData[endIPHeader+6 : endIPHeader+8])

		if got != checksum {
			t.Errorf("Checksum Failed Test %d, got: %v, expected: %v", idx, got, checksum)
		}

		got2 := binary.BigEndian.Uint16(packetData[14+10 : 14+12])

		if got2 != checksum2 {
			t.Errorf("Checksum Failed Test %d, got: %v, expected: %v", idx, got2, checksum2)
		}
	}
}

func TestTCPCheckSum(t *testing.T) {
	for idx, packetData := range tcpCheckSumTest {
		endIPHeader := ((uint8(packetData[14]) & 0x0F) * 4) + 14

		checksum := binary.BigEndian.Uint16(packetData[endIPHeader+16 : endIPHeader+18])
		checksum2 := binary.BigEndian.Uint16(packetData[14+10 : 14+12])

		updateCheckSum(packetData)

		got := binary.BigEndian.Uint16(packetData[endIPHeader+16 : endIPHeader+18])
		...
		if got2 != checksum2 {
			t.Errorf("Checksum2 Failed Test %d, got: %v, expected: %v", idx, got2, checksum2)
		}
	}
